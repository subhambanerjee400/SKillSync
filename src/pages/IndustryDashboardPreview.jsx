...
export default function IndustryDashboardPreview() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f8fafc', color: '#0f172a' }}>
      <header style={{ background: '#fff', borderBottom: '1px solid #e2e8f0', padding: '1rem clamp(1rem, 4vw, 3rem)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '1rem' }}><div style={{ display: 'flex', alignItems: 'center', gap: '.7rem' }}><span style={{ width: 36, height: 36, borderRadius: 10, display: 'grid', placeItems: 'center', background: '#0e4a32' }}><BriefcaseBusiness size={19} color="#fff" /></span><strong>SkillBridge</strong><span style={{ color: '#64748b' }}>Employer portal</span></div><button type="button" onClick={handleLogout} style={{ color: '#475569', display: 'inline-flex', gap: '.4rem', alignItems: 'center' }}><LogOut size={16} />Sign out</button></header>
